...
- Name: stitch-components-simplified.spec.ts >> Two Spies UI — Stitch Components >> Terminal component has proper CSS classes
- Location: e2e/stitch-components-simplified.spec.ts:76:3
...
- generic [ref=e5]:
  ...
  - generic [ref=e19]:
    ...
    - generic [ref=e22]: "9:42:17 PM: Active client: WebSocketClient"
```
